...
if dependencies["client_protocol"]:
    fail("client_protocol must have no direct dependencies in slice 12")
...
print("dependency boundary: four packages, one-way graph, and exact pins passed")
