...
The login transcript uses fixed account `LEARNER`, password `ONLYFORVECTOR`, client entropy `01..20`, server entropy `41..60`, salt `21..40`, generator `7`, and the standard 32-byte Wrath SRP prime. Values were calculated independently with Python standard-library SHA-1, HMAC, arbitrary-precision integers, and a small RC4 reference on 2026-07-22. Production Rust code did not generate the expected bytes.
